...
func ParamPeeling(ctx context.Context, configState *config.State, request Request) api.GetRedirectionResponse {
	response := api.GetRedirectionResponse{}
...
func paramPeelingKeyCheck(configState *config.State, param string, u *url.URL) bool {
